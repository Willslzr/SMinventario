    ...
    <x-slot name="tbody">
        ...
        @foreach ($categorias as $categoria)
            ...
            <td class="text-center">
                <img src="{{asset($categoria->imagen_referencia)}}" alt="{{$categoria->nombre}}" class="img-fluid img-thumbnail" width="100">
            </td>
            <td style="text-align: center; vertical-align: middle;">
            ...
            <td style="text-align: center; vertical-align: middle;">
                <div class="btn-group">
                    <button class="btn btn-warning btn-circle btn-sm" type="button" data-toggle="modal" data-target="#editar" wire:click="abrirModal({{ $categoria }})">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="btn btn-danger btn-circle btn-sm" type="button" data-toggle="modal" data-target="#borrar" wire:click="abrirModal({{ $categoria }})">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 id="borrarLabel">Seguro que quiere borrar este tipo de producto?</h5>
            ...
            <div class="modal-content bg-gradient-light">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <textarea class="form-control form-control-user" name="descripcion" id="descripcion" wire:model="descripcion" style="height: auto" rows="5"></textarea>
                    </div>
                </div>
